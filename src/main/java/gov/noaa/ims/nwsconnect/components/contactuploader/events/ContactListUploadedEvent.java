...
public class ContactListUploadedEvent extends ComponentEvent<ContactUploader> {
    private final ContactList contactList;

    public ContactListUploadedEvent(ContactUploader source, ContactList contactList) {
        super(source, false);
