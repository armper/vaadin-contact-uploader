...
@Component
public class AddOrganizationToImsStrategy implements IssueHandlerStrategy {

    @Override
    public void handleIssue(CureDetails cureDetails) {
        Notification.show("Add organization to IMS", 3000, Notification.Position.TOP_CENTER);
    }
