...
@Component
public class NoaaEmailIssueHandlerStrategy implements IssueHandlerStrategy {
    @Override
    public void handleIssue(CureDetails cureDetails) {

        Notification notification = new Notification("NOAA registration link sent to " + cureDetails.getContactToBeImported().getEmailAddress1() + "",
                3000,
